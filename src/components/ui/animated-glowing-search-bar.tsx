...
const AnimatedGlowingSearchBar: React.FC<SearchComponentProps> = ({ onSearch, isLoading }) => {
    ...
    <div className="relative flex items-center justify-center w-full max-w-md mx-auto">
      <div id="poda" className="relative flex items-center justify-center group w-full">
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[3px]
                        ...
                        before:bg-[radial-gradient(closest-side,#cf30aa,transparent)] before:transition-all before:duration-2000 group-hover:before:rotate-[-120deg] group-focus-within:before:rotate-[420deg] group-focus-within:before:duration-[4000ms]">
        </div>
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        ...
                        before:bg-[radial-gradient(closest-side,#837484,transparent)] before:transition-all before:duration-2000 group-hover:before:rotate-[-98deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]">
        </div>
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px]
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[radial-gradient(closest-side,#837484,transparent)] before:transition-all before:duration-2000 group-hover:before:rotate-[-98deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]">
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px]
                        ...
                        before:bg-[radial-gradient(closest-side,#d6d6e6,transparent)] before:transition-all before:duration-2000 group-hover:before:rotate-[-97deg] group-focus-within:before:rotate-[443deg] group-focus-within:before:duration-[4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px]
                        ...
                        before:bg-[radial-gradient(closest-side,#cf30aa,transparent)] before:transition-all before:duration-2000 group-hover:before:rotate-[-110deg] group-focus-within:before:rotate-[430deg] group-focus-within:before:duration-[4000ms]">
        </div>

        <div id="main" className="relative group">
          <input
            placeholder={isLoading ? 'Searching...' : 'Enter Instagram username...'}
            type="text"
            className="w-[300px] h-[50px] rounded-full bg-[#161329] px-12 text-[#d6d6e6] text-lg outline-none border border-transparent
                       transition-all duration-2000 focus:border-[#cf30aa] focus:ring-2 focus:ring-[#cf30aa] focus:ring-opacity-50"
            value={query}
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg
                          ...
                          before:bg-[radial-gradient(closest-side,#cf30aa,transparent)] before:transition-all before:duration-2000 before:brightness-135 before:animate-spin-slow">
          </div>
