  ...
  const mockChatData = [
    {
      ...
      messages: [
        ...
        { id: '10', sender: 'other' as const, text: 'me manda aquela foto que vc tirou depois? só pra eu lembrar do seu sorriso.', timestamp: '23:25', isBlurred: false }, // Desborrado
      ],
    },
    {
      id: 2,
      ...
      messages: [
        ...
        { id: '10', sender: 'other' as const, text: 'leva aquele "brinquedinho" que vc usou da última vez.', timestamp: '18:15', isBlurred: false }, // Desborrado
      ],
    },
    {
      id: 3,
      ...
      messages: [
        ...
        { id: '10', sender: 'other' as const, text: 'só vem. e se prepara. foi uma delicia da ultima vez', timestamp: '09:20', isBlurred: false }, // Desborrado
      ],
    },
    {
      id: 4,
      ...
      messages: [
        ...
        { id: '10', sender: 'other' as const, text: 'entendeu o recado, né? te espero.', timestamp: '08:40', isBlurred: false }, // Desborrado
      ],
    },
    {
      id: 5,
      ...
      messages: [
        ...
        { id: '10', sender: 'other' as const, text: 'não demora. tô te esperando do jeito que vc gosta.', timestamp: '20:10', isBlurred: false }, // Desborrado
      ],
    },
  ];
