  ...
  const mockChatData: ChatData[] = [ // Tipagem explícita para mockChatData
    ...
    },
    {
      ...
      messages: [
        ...
        { id: '7', sender: 'other', text: 'você é meu vício.', timestamp: '18:11', isBlurred: true },
        { id: '8', sender: 'self', text: 'e você é o meu ponto fraco.', timestamp: '18:12', isBlurred: true },
        { id: '9', sender: 'other', text: 'então se prepara pra amanhã.', timestamp: '18:12', isBlurred: true },
        { id: '10', sender: 'other', text: 'leva aquele "brinquedinho" que vc usou da última vez.', timestamp: '18:15', isBlurred: false },
      ],
    },
    {
      id: 3,
      ...
      messages: [
        ...
        { id: '5', sender: 'other', text: 'você não tem ideia do que eu faria pra estar aí.', timestamp: '09:15', isBlurred: true },
        { id: '6', sender: 'self', text: 'me conta...', timestamp: '09:16', isBlurred: true },
    ...
    },
    {
      ...
      messages: [
        ...
        { id: '5', sender: 'other', text: 'meu corpo todo tá te pedindo.', timestamp: '08:34', isBlurred: true },
