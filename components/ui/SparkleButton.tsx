...
const SparkleButton: React.FC<SparkleButtonProps> = ({ onClick, isLoading, children }) => {
  ...
  const buttonClasses = `
    ...
    ${isActive ? 'scale-105 shadow-xl shadow-purple-500/75' : 'scale-100 shadow-lg shadow-purple-500/50'}
    ...
    focus:outline-none focus:ring-4 focus:ring-purple-500/50 focus:ring-offset-2 focus:ring-offset-black
  `;
